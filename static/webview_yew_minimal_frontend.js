...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.webview_yew_minimal_frontend = factory();
    }
}( this, function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_17c6c85da20fd23f248f73d234351b6c600f13f2": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){var callback=($1);var listener=event=>callback(event.detail);document.addEventListener("send_back",listener);return{name:"send_back",callback:callback,listener:listener};})());
            },
            ...
            "__cargo_web_snippet_ee93f3162ba7b7b02a7abc796f40d1c6205da825": function() {
                external.invoke("receive");
            },
